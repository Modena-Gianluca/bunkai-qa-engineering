---
description: Generate or update .context/master-test-plan.md — a business-derived test roadmap answering "what to test in this application, and why does it matter". Sits on top of business-data-map and business-feature-map. CREATE mode if absent, UPDATE mode (with diff + confirmation) if present. Triggers on 'master test plan', 'what should I test', 'testing strategy'. Requires business-data-map.md.
subtask: true
---
