---
description: Generate a plain-English breakdown of what automated tests do — which ATCs run, what assertions fire, how data flows. Reads the actual test source code. Triggers on "explain these tests", "what does this test do", "break down the test suite". Input: file path, ATC ID, ticket ID, or module name.
subtask: true
---
