---
description: Repair broken TMS traceability links between User Story, ATP, ATR, and Test Cases. Audits links first, presents a fix plan, waits for confirmation, applies fixes, verifies. Triggers on "fix traceability", "traceability links broken", "link test cases to story". Input: ticket ID.
subtask: true
---
