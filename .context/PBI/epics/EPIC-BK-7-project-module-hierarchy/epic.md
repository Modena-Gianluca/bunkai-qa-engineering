...
| [BK-266](https://jira.upexgalaxy.com/browse/BK-266) | TMS-Projects | Browse workspace projects in an index with a dedicated create route | - | High | Ready For Release |
| [BK-398](https://jira.upexgalaxy.com/browse/BK-398) | Command Palette | Search and jump across the workspace | - | Medium | Ready For Release |
| [BK-443](https://jira.upexgalaxy.com/browse/BK-443) | App Shell | Save, name, and return to a filtered view | - | Medium | Backlog |
| [BK-509](https://jira.upexgalaxy.com/browse/BK-509) | 🚀 TMS-Project | Create a project inside a workspace | - | Medium | Ready For Release |
| [BK-601](https://jira.upexgalaxy.com/browse/BK-601) | TMS-Module | See what is archived and restore an archived module | - | Medium | Backlog |
