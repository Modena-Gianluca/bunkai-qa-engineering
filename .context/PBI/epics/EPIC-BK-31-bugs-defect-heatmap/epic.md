...
| --- | ----- | ------ | -------- | ------ |
| [BK-40](https://jira.upexgalaxy.com/browse/BK-40) | TMS-Defect Filing | File a defect from a failing run step | - | Medium | Ready For Release |
...
| [BK-42](https://jira.upexgalaxy.com/browse/BK-42) | TMS-Defect Heatmap | View count and week-over-week trend per module | - | Medium | Ready For Release |
| [BK-43](https://jira.upexgalaxy.com/browse/BK-43) | TMS-Defect Sync | Sync defects one-way to the external tracker | - | Medium | ABORTED |
| [BK-264](https://jira.upexgalaxy.com/browse/BK-264) | TMS-Defect Triage | Assign a defect to a workspace member and update its status | - | Medium | Ready For Release |
| [BK-337](https://jira.upexgalaxy.com/browse/BK-337) | TMS-Defect Detail | Open a defect and read its full record | - | Medium | Ready For Release |
| [BK-371](https://jira.upexgalaxy.com/browse/BK-371) | TMS-Defect Sync | Point a project at a Jira destination | - | Medium | Backlog |
| [BK-372](https://jira.upexgalaxy.com/browse/BK-372) | TMS-Defect Sync | Send a newly filed defect to Jira | - | Medium | Backlog |
| [BK-373](https://jira.upexgalaxy.com/browse/BK-373) | TMS-Defect Sync | Recover a failed sync and show its state | - | Medium | Backlog |
...
| [BK-594](https://jira.upexgalaxy.com/browse/BK-594) | TMS-Defect Filing | Attach screenshots as evidence when filing a defect | - | Medium | Backlog |
| [BK-718](https://jira.upexgalaxy.com/browse/BK-718) | TMS-Defect Heatmap | See newly filed defects appear without refreshing | - | Medium | Backlog |
