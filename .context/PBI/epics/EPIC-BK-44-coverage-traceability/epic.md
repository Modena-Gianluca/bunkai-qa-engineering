...
| --- | ----- | ------ | -------- | ------ |
| [BK-45](https://jira.upexgalaxy.com/browse/BK-45) | TMS-Traceability | Render full US to bug evidence chain in one read | - | Medium | Ready For Release |
...
| [BK-47](https://jira.upexgalaxy.com/browse/BK-47) | TMS-Coverage | Compute time-to-green per user story from run and bug history | - | Medium | Ready For Release |
| [BK-48](https://jira.upexgalaxy.com/browse/BK-48) | TMS-Traceability | Filter the chain by verdict, module, and date range | - | Medium | Ready For Release |
...
| [BK-50](https://jira.upexgalaxy.com/browse/BK-50) | TMS-Traceability | Export the assembled chain as a read-only snapshot | - | Medium | Ready For Release |
