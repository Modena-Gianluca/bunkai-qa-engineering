...
***2026-08-21 update****: the Shift-Left refinement session identified 4 real ambiguities (see "QA Refinements" below) and all 4 were resolved the same day by the AI Product Owner & AI Tech Lead Ruling comment. Story Points estimated at ****8*** (relative sizing against [https://jira.upexgalaxy.com/browse/BK-497#icft=BK-497](https://jira.upexgalaxy.com/browse/BK-497#icft=BK-497) = 5, [https://jira.upexgalaxy.com/browse/BK-498#icft=BK-498](https://jira.upexgalaxy.com/browse/BK-498#icft=BK-498) = 8 — see the estimation discussion in this Story's session). Story is now `Ready For Dev`.
...
See the "AI Product Owner & AI Tech Lead Ruling — [https://jira.upexgalaxy.com/browse/BK-499#icft=BK-499](https://jira.upexgalaxy.com/browse/BK-499#icft=BK-499) Shift-Left Follow-up" comment for full rationale per question. Summary of rulings:
...
- [BK-670](https://jira.upexgalaxy.com/browse/BK-670): ATR: BK-499: Story Testing _(ACTIVE)_

### Defect (1)

- [BK-623](https://jira.upexgalaxy.com/browse/BK-623): PAT: Bunkai API Tokens: POST /me/active-workspace 403 message omits "Use a browser session." required by AC5 _(Closed)_

### Storys (3)

- [BK-595](https://jira.upexgalaxy.com/browse/BK-595): TMS-ATC API | Read a single ATC by id _(Backlog)_
...
- [BK-669](https://jira.upexgalaxy.com/browse/BK-669): ATP: BK-499: PAT | Enforce capability scopes on read, identity and notification routes _(Planning)_

### Test Set (1)

- [BK-668](https://jira.upexgalaxy.com/browse/BK-668): ATS: BK-499: PAT | Enforce capability scopes on read, identity and notification routes _(Close)_
